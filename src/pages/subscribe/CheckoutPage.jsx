...
import { Loader2, ShieldCheck, XCircle, ArrowLeft, ArrowRight } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  // Guards against a double init under React 18 StrictMode (effect
  // runs twice in dev) and Moyasar's own re-render behaviour.
  ...
  return (
    <div
      className="min-h-screen flex items-start justify-center px-5 py-12"
      style={{ background: 'var(--bg-canvas)' }}
    >
      <div
        className="w-full max-w-[520px] rounded-[20px] animate-fade-up"
        style={{
          background: 'var(--bg-surface)',
          border: '1px solid var(--border-default)',
          padding: '32px 28px',
