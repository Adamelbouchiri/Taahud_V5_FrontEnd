...
export default {
  ...
  broker: {
    nav: { opportunities: 'Opportunities', drafts: 'Drafts' },
    accountStatus: {
      pending_review: 'Pending review',
      active: 'Active',
      suspended: 'Suspended',
    ...
    feeStatus: {
      not_set: 'Not set',
      pending_owner_decision: 'Awaiting the owner',
    ...
    fee: {
      ...
      subtitle: 'You and the owner agree the rate before the project draft is prepared.',
      percent: '{value}%',
      proposedLabel: 'Proposed rate',
      counterLabel: "Owner's counter-proposal",
      approvedLabel: 'Agreed rate',
      proposedAt: 'Proposed',
      counteredAt: 'Counter-proposed',
      resolvedAt: 'Agreed',
      notSetHint: 'You have not proposed a rate yet. Propose one for the owner to decide on.',
      waitingOwner: 'The rate has been sent to the owner and we are waiting for their decision.',
      waitingBroker: 'Your counter-proposal has been sent and we are waiting for the broker.',
      approvedHint: 'Both sides agreed on the rate. Changing it now needs mutual consent.',
      rejectedHint: 'You rejected the counter-proposal. The opportunity stays reserved for you and you can propose a new rate.',
      rejectedHintOwner: 'The broker rejected your counter-proposal. They may propose a new rate later.',
      onlyOneRound: 'Only one counter-proposal round is allowed, and the broker’s answer to it is final.',
      propose: 'Propose a rate',
      repropose: 'Propose a new rate',
      form: {
        title: 'Propose the commission rate',
        label: 'Percentage',
        hint: 'Between {min}% and {max}% of the contract value.',
        submit: 'Send to the owner',
      },
      ownerDecision: {
        title: 'Your decision on the commission rate',
        body: 'Broker {name} proposed {percent} of the contract value. You can approve it or counter with a lower rate.',
        approve: 'Approve the rate',
        counter: 'Counter with a lower rate',
        counterLabel: 'Your proposed rate',
        counterHint: 'Must be lower than {percent}.',
        submitCounter: 'Send counter-proposal',
        confirmApprove: {
          title: 'Approve the rate',
          message: 'Once approved the rate is final and can only change with both sides’ consent.',
          confirm: 'Approve',
        },
      },
      brokerResponse: {
        title: 'Respond to the counter-proposal',
        body: 'The owner proposed {counter} instead of {proposed}. Your answer is final.',
        accept: 'Accept the counter-proposal',
        reject: 'Reject',
        rejectHint: 'Rejecting does NOT release the hold — the opportunity stays reserved and you can propose a new rate.',
        confirmReject: {
          title: 'Reject the counter-proposal',
          message: 'The owner’s rate will be rejected and the opportunity stays reserved for you. You can propose a new rate later.',
          confirm: 'Reject',
        },
      },
      errors: {
        range: 'The rate must be between {min}% and {max}%.',
        counterTooHigh: 'The counter-proposal must be lower than the proposed rate.',
        generic: 'The action failed. Please try again.',
      },
    },
    invite: {
      title: 'Invite the owner',
      subtitle: 'Create the invitation link, then copy it and send it to the owner however you prefer.',
      none: 'No invitation has been created for this opportunity yet.',
      create: 'Create invitation',
      recreate: 'Create a new invitation',
      oneOnly: 'One invitation per opportunity. To send a new one, cancel the current invitation first.',
      form: {
        title: 'Invitee details',
        name: 'Owner name',
        namePlaceholder: 'Person or company name',
        phone: 'Phone',
        email: 'Email',
        notes: 'Notes',
        notesPlaceholder: 'e.g. Met them at the property development expo...',
        notesHint: 'Internal only — the invitee never sees this.',
      ...
      link: {
        ...
        copy: 'Copy link',
        copied: 'Copied',
        hint: 'Send the link to the owner over WhatsApp, SMS or email — the platform sends no automatic notification.',
        expires: 'The link expires on {date}',
        validDays: 'The link is valid for {days} days from creation.',
      },
      invitee: 'Invitee',
      accepted: {
        title: 'The owner accepted the invitation',
        body: 'They created their account and are now linked to you as their broker. Next: agree the commission rate, then prepare the draft.',
        at: 'Accepted',
      },
      expiredHint: 'This invitation expired or was cancelled. You can create a new one.',
      cancel: 'Cancel invitation',
      cancelConfirm: {
        title: 'Cancel invitation',
        message: 'The link stops working immediately. You can create a new invitation afterwards.',
    ...
    drafts: {
      ...
      subtitle: 'The drafts you prepare for owners — in preparation, or waiting for the owner to publish.',
      loadError: 'Could not load the drafts.',
      empty: {
        title: 'No drafts',
        description: 'Once the owner accepts the invitation and the rate is approved, you can prepare the project draft from the opportunity page.',
      },
      phase: {
        withBroker: 'In preparation',
        withOwner: 'Waiting for the owner',
      },
      card: {
        title: 'Project draft',
        subtitle: 'You prepare the draft, then hand it to the owner to review and publish.',
        openDraft: 'Open draft',
        prereqTitle: 'Before preparing the draft:',
        prereqInvitation: 'The owner accepts the invitation',
        prereqFee: 'The commission rate is approved',
        prereqExists: 'No draft exists for this opportunity',
      },
      create: 'Create the project draft',
      createTitle: 'Prepare the project draft',
      createSubtitle: 'Fill in the project details on the owner’s behalf. A draft never appears in the arenas and stays editable until you hand it to the owner.',
      editTitle: 'Edit draft',
      editSubtitle: 'You can edit every field while the draft is still with you. Once handed off, editing passes to the owner.',
      notFound: 'The draft does not exist or is no longer available to you.',
      owner: 'Owner',
      feeSnapshot: 'Snapshotted commission rate',
      save: 'Save changes',
      saving: 'Saving...',
      saved: 'Changes saved.',
      handedOffAt: 'Handed to the owner',
      lockedHint: 'The draft is with the owner and you can no longer edit it. They review and publish it from here.',
      handOff: 'Hand the draft to the owner',
      handOffConfirm: {
        title: 'Hand the draft to the owner',
        message: 'After handing off you can no longer edit the draft — the owner edits and publishes it. This cannot be undone.',
        confirm: 'Hand off',
      },
      errors: {
        generic: 'Could not save the draft. Please try again.',
        fixFields: 'Please correct the required fields.',
      },
    },
    attribution: {
      title: 'Project broker',
      feeLabel: 'Commission rate',
      viaBroker: 'This project came through the broker',
      opportunityRef: 'Opportunity reference',
    },
    owner: {
      inbox: {
        title: 'Waiting on you',
        drafts: 'drafts waiting for your review',
        fees: 'commission rates waiting for your decision',
        viewDrafts: 'Review the drafts',
        viewFees: 'Review the rates',
      },
      drafts: {
        nav: 'Broker drafts',
        title: 'Drafts waiting for your review',
        subtitle: 'Projects a broker prepared on your behalf. Review them, edit anything you want, then publish.',
        loadError: 'Could not load the drafts.',
        empty: {
          title: 'No drafts',
          description: 'If a broker prepares a project on your behalf, it appears here once they hand it to you.',
        },
        review: 'Review draft',
        editTitle: 'Review the project draft',
        editSubtitle: 'It is your project — you can edit any field before publishing.',
        notFound: 'The draft does not exist, or the broker has not handed it to you yet.',
        brokerNote: 'Broker {name} prepared this draft, and the project will be attributed to them at {percent} once published.',
        save: 'Save changes',
        publish: 'Publish the project',
        publishConfirm: {
          title: 'Publish the project',
          message: 'The project goes to the admin team for review and appears in the arena once approved. The agreed broker rate stays attached to it.',
          confirm: 'Publish',
        },
        published: {
          title: 'The project has been published',
          body: 'The Taahud team will review it before it appears in the arena.',
      ...
      fees: {
        nav: 'Broker rates',
        title: 'Commission rates waiting for your decision',
        subtitle: 'A broker proposed a commission rate on an opportunity of yours. You can approve it or counter with a lower rate.',
        loadError: 'Could not load the requests.',
        empty: {
          title: 'Nothing waiting for your decision',
          description: 'When a broker proposes a commission rate on an opportunity of yours, it appears here.',
        },
        brokerLabel: 'Broker',
      },
    },
  ...
  invitation: {
    ...
    kicker: 'Invitation to join',
    title: 'Welcome {name}',
    subtitle: 'Broker {broker} is inviting you to join Taahud and take your opportunity forward.',
    opportunityLabel: 'Opportunity',
    brokerLabel: 'Broker',
    feeLabel: 'Proposed commission rate',
    feeNotSet: 'Not set yet',
    formTitle: 'Create your account',
    formHint: 'Complete your details to create the account and sign in straight away.',
    submit: 'Accept and create my account',
    submitting: 'Creating the account...',
    haveAccount: 'Already have an account?',
    signIn: 'Sign in',
    signedInWarning: 'You are signed in with another account. Accepting the invitation creates a NEW account and signs you out of the current one.',
    expired: {
      title: 'This invitation has expired',
      body: 'The invitation is no longer valid — it may have expired, been cancelled, or already been used. Ask the broker to send you a new one.',
    },
    notFound: {
      title: 'Invitation not found',
      body: 'Check the link you were sent, or ask the broker for a new one.',
    },
    error: {
      title: 'Could not check the invitation',
      body: 'Something went wrong while reading the invitation. Please try again.',
      retry: 'Try again',
    },
    home: 'Home',
  },
