...
export default {
  ...
  landing: {
    ...
    plans: {
      eyebrow: 'الباقات',
      title: 'باقات مصمّمة لكل دور في القطاع',
      subtitle:
      ...
      addon: {
        ...
        body:
          'أضف {price} فقط على باقتك الشهرية لفتح الساحة الخاصة عهد والوصول لمشاريع حصرية بقيم تجاوز {threshold}.',
        price: '٦٠٠ ر.س',
  ...
  arena: {
    public: {
      ...
      short: 'نمو',
      desc:
        'فرص عامّة مجمّعة من مصادر خارجيّة (اعتماد، فرصة، مقاول...) تظهر للموردين والمقاولين والمكاتب الهندسيّة.',
