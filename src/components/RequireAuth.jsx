 ...
 *  presence of an auth token in localStorage:
 *
 *    - If a token exists → render the protected children.
 *    - If not → redirect to /login, remembering the originally
 *      intended path in `location.state.from` so LoginPage can
 *      send the user back where they were headed after a
 *      successful login.
 *
 ...
 *  a UserProvider above them, so we read from localStorage
 *  directly instead.
 * ============================================================ */
